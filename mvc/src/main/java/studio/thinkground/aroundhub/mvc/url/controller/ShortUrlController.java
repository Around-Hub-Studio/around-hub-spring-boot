package studio.thinkground.aroundhub.mvc.url.controller;
...
import studio.thinkground.aroundhub.mvc.url.service.ShortUrlService;
...
public class ShortUrlController {
  ...
  @PostMapping()
  public ShortUrlResponse generateShortUrl(String originalUrl) {
    LOGGER.info(
  ...
  @PutMapping("/")
  public ShortUrlResponse updateShortUrl(String originalUrl) {
    return null;
  }
